                            ...
                            <div class="table-responsive">
                                ...
                                <table id="my_edit" class="table my_table" cellpadding="0" cellspacing="0">
                                    ...
                                    @foreach($carts as $cart)
                                        <tr>
                                            <td>
                                                {{date('d/m/Y', strtotime($cart->created_at))}}                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                {{date('d/m/Y', strtotime($cart->desirable_delivery))}}                                            </td>
                                            <td>
                                                <table cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td><a href="{{ URL::to('/'.App::getLocale().'/cabinet/history/detail/'.$cart->id) }}">Detail</a></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
